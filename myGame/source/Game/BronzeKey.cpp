...
namespace Rendering
{
	RTTI_DEFINITIONS(BronzeKey)

		BronzeKey::BronzeKey(Game& game, Camera& camera)
	...
	void BronzeKey::Initialize()
	{
		...
		//Load the texture
		mTextureName = L"Content\\Textures\\BronzeKey.png";
	...
	void BronzeKey::Update(const GameTime& gameTime)
	{
	...
	void BronzeKey::Draw(const GameTime& gameTime)
	{
