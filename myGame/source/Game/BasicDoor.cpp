...
namespace Rendering
{
	RTTI_DEFINITIONS(BasicDoor)
		...
		BasicDoor::BasicDoor(Game& game, Camera& camera, Mouse& mouse)
	...
	void BasicDoor::chestCollected()
	{
		mCollected = true;
	}

	void BasicDoor::Interaction(const GameTime& gameTime)
	{
		XMFLOAT4X4 P;
	...
	void BasicDoor::CreateVertexBuffer(ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer) const
	{
