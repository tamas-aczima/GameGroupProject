...
namespace Rendering
{
	RTTI_DEFINITIONS(Lava)

		Lava::Lava(Game& game, Camera& camera)
	...
	void Lava::Initialize()
	{
		...
		//Load the texture
		mTextureName = L"Content\\Textures\\Lava.jpg";
	...
	void Lava::Update(const GameTime& gameTime)
	{
	...
	void Lava::Draw(const GameTime& gameTime)
	{
