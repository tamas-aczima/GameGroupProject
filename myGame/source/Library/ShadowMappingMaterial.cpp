...
namespace Library
{
    ...
    ShadowMappingMaterial::ShadowMappingMaterial()
        : Material("shadow_mapping"),
		  ...
		  MATERIAL_VARIABLE_INITIALIZATION(ShadowMapSize), MATERIAL_VARIABLE_INITIALIZATION(pos),
	...
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, pos)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, range)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, dir)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, cone)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, att)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, ambient)
	MATERIAL_VARIABLE_DEFINITION(ShadowMappingMaterial, diffuse)
