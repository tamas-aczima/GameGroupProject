...
namespace Library
{
	...
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, pos)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, range)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, dir)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, cone)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, att)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, ambient)
	MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, diffuse)
